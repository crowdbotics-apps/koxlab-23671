"""koxlab_23671 URL Configuration
...
admin.site.site_header = "koXlab"
admin.site.site_title = "koXlab Admin Portal"
admin.site.index_title = "koXlab Admin"

# swagger
api_info = openapi.Info(
    title="koXlab API",
    default_version="v1",
    description="API documentation for koXlab App",
)
